    ...
    <div class="row-fluid">
        <div class="span4">
            ...
            <div id = "div_buttons" class="row-fluid" style="margin-top: 10px;margin-bottom:10px;">
                ...
                <button id="bt_save" type="button" class="btn btn-small" onclick="">Save Safezone</button>
                <button id="bt_editLocation" type="button" class="btn btn-small" onclick="javascript:showSearchAddress();">Edit Locations</button>
                <button id="bt_next" type="button" class="btn btn-small" onclick="javascript:showEditRadius();">Next</button>
                <!--TODO: <button id="bt_dynamicSafezone" type""></button> -->
            </div>
        </div>
        <div class="span8">
            <!--Body content to MAP-->
