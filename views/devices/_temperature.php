<form action="<?php echo $this->make_route('/sensor/' . $deviceID.'/'.$deviceREV); ?>" method="post">
        ...
        <div id="div_propreties_temperature"> 
            <div class="well">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="min_temp_notification" type="number" min="22" max="28" name="min_temp_notification" value="<?php echo $sensor->min_temperature; ?>"/>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="max_temp_notification" type="number" min="22" max="28" name="max_temp_notification" value="<?php echo $sensor->max_temperature; ?>"/>
